...
struct Z_CompiledInDeferFile_FID_Users_jacob_Documents_GitHubMain_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_Test_Enemy_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATest_Enemy, ATest_Enemy::StaticClass, TEXT("ATest_Enemy"), &Z_Registration_Info_UClass_ATest_Enemy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATest_Enemy), 2501838498U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jacob_Documents_GitHubMain_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_Test_Enemy_h_85417588(TEXT("/Script/Bachelor_project"),
