...
// Begin Class ATest_Character Function OnMeleeHitNotify
struct Z_Construct_UFunction_ATest_Character_OnMeleeHitNotify_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ATest_Character_OnMeleeHitNotify_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATest_Character, nullptr, "OnMeleeHitNotify", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ATest_Character_OnMeleeHitNotify_Statics::Function_MetaDataParams), Z_Construct_UFunction_ATest_Character_OnMeleeHitNotify_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_ATest_Character_OnMeleeHitNotify()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ATest_Character_OnMeleeHitNotify_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ATest_Character::execOnMeleeHitNotify)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnMeleeHitNotify();
	P_NATIVE_END;
}
// End Class ATest_Character Function OnMeleeHitNotify
...
void ATest_Character::StaticRegisterNativesATest_Character()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "OnMeleeHitNotify", &ATest_Character::execOnMeleeHitNotify },
...
struct Z_Construct_UClass_ATest_Character_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_StartJumpAnim_MetaData[] = {
		{ "Category", "Animations" },
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MidJumpAnim_MetaData[] = {
		{ "Category", "Animations" },
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_EndJumpAnim_MetaData[] = {
		{ "Category", "Animations" },
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DefaultMappingContext_MetaData[] = {
		{ "Category", "Input" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Input mapping and input actions\n" },
#endif
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Input mapping and input actions" },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RunInput_MetaData[] = {
		{ "Category", "Input" },
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bStartedJump_MetaData[] = {
		{ "Category", "State" },
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bFinishJump_MetaData[] = {
		{ "Category", "State" },
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AbilitySystemComponent_MetaData[] = {
		{ "Category", "Test_Character" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//AbilitySystemComponent\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "AbilitySystemComponent" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MaxHealth_MetaData[] = {
		{ "Category", "Stats" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Stats and variables\n" },
#endif
		{ "ModuleRelativePath", "Public/Player/Test_Character.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Stats and variables" },
#endif
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_StartJumpAnim;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MidJumpAnim;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_EndJumpAnim;
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_RunInput;
	...
	static void NewProp_bStartedJump_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bStartedJump;
	static void NewProp_bMidJump_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bMidJump;
	static void NewProp_bFinishJump_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bFinishJump;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ATest_Character_OnMeleeHitNotify, "OnMeleeHitNotify" }, // 737527168
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_StartJumpAnim = { "StartJumpAnim", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATest_Character, StartJumpAnim), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StartJumpAnim_MetaData), NewProp_StartJumpAnim_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_MidJumpAnim = { "MidJumpAnim", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATest_Character, MidJumpAnim), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MidJumpAnim_MetaData), NewProp_MidJumpAnim_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_EndJumpAnim = { "EndJumpAnim", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATest_Character, EndJumpAnim), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EndJumpAnim_MetaData), NewProp_EndJumpAnim_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_RunInput = { "RunInput", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATest_Character, RunInput), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RunInput_MetaData), NewProp_RunInput_MetaData) };
...
void Z_Construct_UClass_ATest_Character_Statics::NewProp_bIsMoving_SetBit(void* Obj)
{
	((ATest_Character*)Obj)->bIsMoving = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_bIsMoving = { "bIsMoving", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ATest_Character), &Z_Construct_UClass_ATest_Character_Statics::NewProp_bIsMoving_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsMoving_MetaData), NewProp_bIsMoving_MetaData) };
...
void Z_Construct_UClass_ATest_Character_Statics::NewProp_bStartedJump_SetBit(void* Obj)
{
	((ATest_Character*)Obj)->bStartedJump = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_bStartedJump = { "bStartedJump", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ATest_Character), &Z_Construct_UClass_ATest_Character_Statics::NewProp_bStartedJump_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bStartedJump_MetaData), NewProp_bStartedJump_MetaData) };
void Z_Construct_UClass_ATest_Character_Statics::NewProp_bMidJump_SetBit(void* Obj)
{
	((ATest_Character*)Obj)->bMidJump = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_bMidJump = { "bMidJump", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ATest_Character), &Z_Construct_UClass_ATest_Character_Statics::NewProp_bMidJump_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bMidJump_MetaData), NewProp_bMidJump_MetaData) };
void Z_Construct_UClass_ATest_Character_Statics::NewProp_bFinishJump_SetBit(void* Obj)
{
	((ATest_Character*)Obj)->bFinishJump = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_bFinishJump = { "bFinishJump", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ATest_Character), &Z_Construct_UClass_ATest_Character_Statics::NewProp_bFinishJump_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bFinishJump_MetaData), NewProp_bFinishJump_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_VerticalVelocity = { "VerticalVelocity", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATest_Character, VerticalVelocity), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_VerticalVelocity_MetaData), NewProp_VerticalVelocity_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_JumpVelocity = { "JumpVelocity", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATest_Character, JumpVelocity), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_JumpVelocity_MetaData), NewProp_JumpVelocity_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ATest_Character_Statics::NewProp_BulletSize = { "BulletSize", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATest_Character, BulletSize), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BulletSize_MetaData), NewProp_BulletSize_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATest_Character_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_StartJumpAnim,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_MidJumpAnim,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_EndJumpAnim,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_RunInput,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_bIsMoving,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_bStartedJump,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_bMidJump,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_bFinishJump,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATest_Character_Statics::NewProp_VerticalVelocity,
...
struct Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_Player_Test_Character_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATest_Character, ATest_Character::StaticClass, TEXT("ATest_Character"), &Z_Registration_Info_UClass_ATest_Character, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATest_Character), 800987839U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_Player_Test_Character_h_3738694116(TEXT("/Script/Bachelor_project"),
