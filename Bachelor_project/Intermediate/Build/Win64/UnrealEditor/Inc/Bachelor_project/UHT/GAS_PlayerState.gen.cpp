...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AGAS_PlayerState_Statics::NewProp_RangedAttack = { "RangedAttack", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AGAS_PlayerState, RangedAttack), Z_Construct_UClass_UClass, Z_Construct_UClass_UGAS_Ranged_Attack_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RangedAttack_MetaData), NewProp_RangedAttack_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_GAS_PlayerState_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGAS_PlayerState, AGAS_PlayerState::StaticClass, TEXT("AGAS_PlayerState"), &Z_Registration_Info_UClass_AGAS_PlayerState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGAS_PlayerState), 1961701810U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_GAS_PlayerState_h_108124603(TEXT("/Script/Bachelor_project"),
	Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_GAS_PlayerState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_GAS_PlayerState_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
