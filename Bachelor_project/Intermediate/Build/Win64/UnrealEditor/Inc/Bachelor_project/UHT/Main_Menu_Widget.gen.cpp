...
struct Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_Player_Main_Menu_Widget_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMain_Menu_Widget, UMain_Menu_Widget::StaticClass, TEXT("UMain_Menu_Widget"), &Z_Registration_Info_UClass_UMain_Menu_Widget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMain_Menu_Widget), 793568030U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Bruker_Documents_GitHub_Bachelor_Project_Bachelor_project_Source_Bachelor_project_Public_Player_Main_Menu_Widget_h_572682258(TEXT("/Script/Bachelor_project"),
